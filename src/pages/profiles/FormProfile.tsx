...
const FormProfile: React.FC<FormProfileProps> = ({ profile, action, onClose, onSave }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <button
            type="button"
            className="bg-gray-50 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-4"
            onClick={onClose}
          >
            Cancelar
          </button>
          <button
            type="submit"
            className="bg-blue-70 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Salvar
          </button>
      </div>
